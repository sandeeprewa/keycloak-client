...
//    final Principal principal = (Principal) request.getUserPrincipal();
    ...
    KeycloakPrincipal<KeycloakSecurityContext> principal = (KeycloakPrincipal)request.getUserPrincipal();
    
    System.out.println("principal.getName();"+ principal.getName());
    
    KeycloakSecurityContext kss=   principal.getKeycloakSecurityContext();
	...
	public String privateTest(HttpServletRequest request) {
	    ...
	    KeycloakPrincipal<KeycloakSecurityContext> principal1 = (KeycloakPrincipal)request.getUserPrincipal();
